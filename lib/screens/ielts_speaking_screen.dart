            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('select_topic'.tr, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: Color(0xFF1A1A2E))),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(children: [
                            const Icon(Icons.mic_rounded, color: Color(0xFF7B1FA2), size: 20),
                            const SizedBox(width: 8),
                            Text('speaking_strategies'.tr, style: const TextStyle(color: Color(0xFF4A148C), fontSize: 14, fontWeight: FontWeight.w800)),
                          ]),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (topic.cueCard != null) ...[
                      Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Row(children: [
                            const Icon(Icons.card_membership_rounded, color: Color(0xFF9C27B0), size: 18),
                            const SizedBox(width: 8),
                            Text('cue_card'.tr, style: const TextStyle(color: Color(0xFF6A1B9A), fontSize: 14, fontWeight: FontWeight.w800)),
                          ]),
                    ...
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Row(children: [
                          const Icon(Icons.tips_and_updates_rounded, color: Color(0xFF2E7D32), size: 18),
                          const SizedBox(width: 8),
                          Text('sample_answer'.tr, style: const TextStyle(color: Color(0xFF1B5E20), fontSize: 14, fontWeight: FontWeight.w800)),
                        ]),
                        const SizedBox(height: 10),
                    ...
                    if (topic.vocabularyTips.isNotEmpty) ...[
                      ...
                      Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Row(children: [
                            const Icon(Icons.auto_stories_rounded, color: Color(0xFF1565C0), size: 18),
                            const SizedBox(width: 8),
                            Text('useful_vocab'.tr, style: const TextStyle(color: Color(0xFF0D47A1), fontSize: 14, fontWeight: FontWeight.w800)),
                          ]),
                          const SizedBox(height: 10),
                    ...
                    if (topic.grammarTips.isNotEmpty) ...[
                      ...
                      Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Row(children: [
                            const Icon(Icons.spellcheck_rounded, color: Color(0xFFE65100), size: 18),
                            const SizedBox(width: 8),
                            Text('grammar_tips'.tr, style: const TextStyle(color: Color(0xFFBF360C), fontSize: 14, fontWeight: FontWeight.w800)),
                          ]),
                          const SizedBox(height: 10),
