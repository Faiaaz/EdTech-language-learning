...
const _bn = <String, String>{
  ...
  'forum_new_thread': 'নতুন থ্রেড',
  'forum_no_threads': 'এখনো কোনো থ্রেড নেই। আলোচনা শুরু করুন!',
  'forum_anonymous': 'মেম্বার',
  'forum_thread': 'থ্রেড',
  'forum_comments': 'কমেন্ট',
  'forum_no_comments': 'এখনো কোনো কমেন্ট নেই।',
  'forum_comment_hint': 'কমেন্ট লিখুন…',
  'forum_reply_hint': 'রিপ্লাই লিখুন…',
  'forum_reply': 'রিপ্লাই',
  'forum_replying_to': '@name-কে রিপ্লাই',
  'forum_login_to_comment': 'কমেন্ট করতে Sign in করুন',
  'forum_title_label': 'শিরোনাম',
  'forum_body_label': 'বার্তা',
  'forum_title_required': 'শিরোনাম দিন',
  'forum_body_required': 'বার্তা লিখুন',
  'forum_post': 'পোস্ট',
  'forum_error': 'কিছু সমস্যা হয়েছে',
  'forum_login_required_title': 'Sign in দরকার',
  'forum_login_required_body': 'পোস্ট বা কমেন্ট করতে Sign in করুন।',
  'forum_delete_post_title': 'থ্রেড মুছবেন?',
  'forum_delete_post_body': 'এটা undo করা যাবে না।',
  'forum_edit_post': 'থ্রেড এডিট',
  'forum_save': 'সেভ',
  'forum_delete_comment_title': 'কমেন্ট মুছবেন?',
  'forum_delete_comment_body': 'কমেন্ট স্থায়ীভাবে মুছে ফেলবেন?',
  'forum_edit_comment': 'কমেন্ট এডিট',
